...
export const Carousel = ({ config, content, className }) => {
    ...
    return (_jsxs("div", { className: [styles.hyune_carousel_wrapper, className].join(' '), onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(true), children: [_jsx("div", { className: styles.carousel_content, style: {
                    // backgroundColor: layout === 'wide' ? helperConfig.backgroundColor : 'transparent',
                    width: '100%',
                }, children: _jsx("div", { className: [styles.carousel_content_inner].join(' '), style: {
                        aspectRatio: `${aspectRatio} `,
                    }, children: _jsxs(_Fragment, { children: [_jsx(FitItemList, { content: visibleImages, config: helperConfig, translateCSS: translateCSS }), countShow && (_jsx("div", { className: styles.carousel_count_wrapper, children: _jsxs("div", { className: styles.carousel_count, children: [currentIdx + 1, "/", content.length] }) }))] }) }) }), isHovered && arrowShow && (_jsxs(_Fragment, { children: [_jsx("div", { className: [styles.modified_wrapper, styles.modified_wrapper_left].join(' '), children: _jsx("button", { className: styles.arrow, onClick: handleCountdown, children: _jsx(IconArrowLeft, { fontSize: 24, width: 24, height: 24, color: "white" }) }) }), _jsx("div", { className: [styles.modified_wrapper, styles.modified_wrapper_right].join(' '), children: _jsx("button", { className: styles.arrow, onClick: handleCountUp, children: _jsx(IconArrowRight, { fontSize: 24, width: 24, height: 24, color: "white" }) }) })] }))] }));
};
